 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://bankws.softeng.sapienza.it/", wsdlLocation = "http://127.0.0.1:8080/BankInterface?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://127.0.0.1:8080/BankInterface?wsdl");
